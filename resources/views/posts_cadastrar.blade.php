...
<div class="row mt">
  <div class="col-lg-12">
    ...
    <form class="form-horizontal style-form" id="form" method="post" action="/posts/cadastrar/save"  enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="form-panel">
            ...
            <div class="form-group">
                <div class="col-sm-11 grupo_btn_cadastro">
                    ...
                    <button type="button" class="btn btn-success btn_link" id="btn-enviar">Cadastrar</button>
                </div>
            </div>
